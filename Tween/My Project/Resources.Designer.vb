...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  新しいバージョンが公開されています。実行には.NET Framework 4 (Full)のインストールが必要です。インストール後に再度お試しください。 に類似しているローカライズされた文字列を検索します。
        '''</summary>
        Friend ReadOnly Property CheckNewVerV4() As String
            Get
                Return ResourceManager.GetString("CheckNewVerV4", resourceCulture)
            End Get
        End Property
