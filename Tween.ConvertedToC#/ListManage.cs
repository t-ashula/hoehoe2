...
namespace Tween
{
	...
	public partial class ListManage
	{
		...
		private void ListsList_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			...
			this.GetMoreUsersButton.Text = (this.UserList.Items.Count > 0 ? Tween.My.Resources.ListManageGetMoreUsers2 : Tween.My.Resources.ListManageGetMoreUsers1).ToString();
		}
		...
		private void OKButton_Click(System.Object sender, System.EventArgs e)
		{
			...
			if (string.IsNullOrEmpty(this.NameTextBox.Text)) {
				MessageBox.Show(Tween.My.Resources.ListManageOKButton1);
				return;
			}
		...
		private void GetListMembersCallback(string result)
		{
			if (result == this.ListsList.SelectedItem.ToString()) {
				this.ListsList_SelectedIndexChanged(this.ListsList, EventArgs.Empty);
				this.GetMoreUsersButton.Text = Tween.My.Resources.ListManageGetMoreUsers1;
			} else {
				MessageBox.Show(string.Format(Tween.My.Resources.ListManageGetListMembersCallback1, result));
			}
		}
		...
		private void DeleteUserButton_Click(System.Object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show(Tween.My.Resources.ListManageDeleteUser1, "Tween", MessageBoxButtons.OKCancel) == DialogResult.OK) {
				string rslt = this.tw.RemoveUserToList(list.Id.ToString(), user.Id.ToString());

				if (!string.IsNullOrEmpty(rslt)) {
					MessageBox.Show(string.Format(Tween.My.Resources.ListManageDeleteUser2, rslt));
					return;
				}
		...
		private void DeleteListButton_Click(System.Object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show(Tween.My.Resources.ListManageDeleteLists1, "Tween", MessageBoxButtons.OKCancel) == DialogResult.OK) {
				string rslt = "";

				rslt = this.tw.DeleteList(list.Id.ToString());

				if (!string.IsNullOrEmpty(rslt)) {
					MessageBox.Show(Tween.My.Resources.ListManageOKButton2, rslt);
					return;
				}
				...
				if (!string.IsNullOrEmpty(rslt)) {
					MessageBox.Show(Tween.My.Resources.ListsDeleteFailed, rslt);
					return;
				}
		...
		{
			using (FormInfo dlg = new FormInfo(this, Tween.My.Resources.ListsGetting, RefreshLists_Dowork)) {
				dlg.ShowDialog();
				if (!string.IsNullOrEmpty((string)dlg.Result)) {
					MessageBox.Show(string.Format(Tween.My.Resources.ListsDeleteFailed, (string)dlg.Result));
					return;
				}
			}
		}
