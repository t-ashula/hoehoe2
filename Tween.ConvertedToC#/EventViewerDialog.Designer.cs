...
namespace Tween
{
	...
	partial class EventViewerDialog : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.CheckBox withEventsField_CheckExcludeMyEvent;
		internal System.Windows.Forms.CheckBox CheckExcludeMyEvent {
			get { return withEventsField_CheckExcludeMyEvent; }
			set {
				if (withEventsField_CheckExcludeMyEvent != null) {
					withEventsField_CheckExcludeMyEvent.CheckedChanged -= CheckExcludeMyEvent_CheckedChanged;
				}
				withEventsField_CheckExcludeMyEvent = value;
				if (withEventsField_CheckExcludeMyEvent != null) {
					withEventsField_CheckExcludeMyEvent.CheckedChanged += CheckExcludeMyEvent_CheckedChanged;
				}
			}
		}
		private System.Windows.Forms.Button withEventsField_ButtonRefresh;
		internal System.Windows.Forms.Button ButtonRefresh {
			get { return withEventsField_ButtonRefresh; }
			set {
				if (withEventsField_ButtonRefresh != null) {
					withEventsField_ButtonRefresh.Click -= ButtonRefresh_Click;
				}
				withEventsField_ButtonRefresh = value;
				if (withEventsField_ButtonRefresh != null) {
					withEventsField_ButtonRefresh.Click += ButtonRefresh_Click;
				}
			}
		}
		private System.Windows.Forms.TabControl withEventsField_TabEventType;
		internal System.Windows.Forms.TabControl TabEventType {
			get { return withEventsField_TabEventType; }
			set {
				if (withEventsField_TabEventType != null) {
					withEventsField_TabEventType.SelectedIndexChanged -= TabEventType_SelectedIndexChanged;
					withEventsField_TabEventType.Selecting -= TabEventType_Selecting;
				}
				withEventsField_TabEventType = value;
				if (withEventsField_TabEventType != null) {
					withEventsField_TabEventType.SelectedIndexChanged += TabEventType_SelectedIndexChanged;
					withEventsField_TabEventType.Selecting += TabEventType_Selecting;
				}
		...
		private System.Windows.Forms.ListView withEventsField_EventList;
		internal System.Windows.Forms.ListView EventList {
			get { return withEventsField_EventList; }
			set {
				if (withEventsField_EventList != null) {
					withEventsField_EventList.DoubleClick -= EventList_DoubleClick;
					withEventsField_EventList.RetrieveVirtualItem -= EventList_RetrieveVirtualItem;
					withEventsField_EventList.CacheVirtualItems -= EventList_CacheVirtualItems;
				}
				withEventsField_EventList = value;
				if (withEventsField_EventList != null) {
					withEventsField_EventList.DoubleClick += EventList_DoubleClick;
					withEventsField_EventList.RetrieveVirtualItem += EventList_RetrieveVirtualItem;
					withEventsField_EventList.CacheVirtualItems += EventList_CacheVirtualItems;
		...
		private System.Windows.Forms.TextBox withEventsField_TextBoxKeyword;
		internal System.Windows.Forms.TextBox TextBoxKeyword {
			get { return withEventsField_TextBoxKeyword; }
			set {
				if (withEventsField_TextBoxKeyword != null) {
					withEventsField_TextBoxKeyword.KeyPress -= TextBoxKeyword_KeyPress;
				}
				withEventsField_TextBoxKeyword = value;
				if (withEventsField_TextBoxKeyword != null) {
					withEventsField_TextBoxKeyword.KeyPress += TextBoxKeyword_KeyPress;
				}
			}
		...
		private System.Windows.Forms.CheckBox withEventsField_CheckBoxFilter;
		internal System.Windows.Forms.CheckBox CheckBoxFilter {
			get { return withEventsField_CheckBoxFilter; }
			set {
				if (withEventsField_CheckBoxFilter != null) {
					withEventsField_CheckBoxFilter.CheckedChanged -= TabEventType_SelectedIndexChanged;
				}
				withEventsField_CheckBoxFilter = value;
				if (withEventsField_CheckBoxFilter != null) {
					withEventsField_CheckBoxFilter.CheckedChanged += TabEventType_SelectedIndexChanged;
				}
			}
		...
		private System.Windows.Forms.Button withEventsField_SaveLogButton;
		internal System.Windows.Forms.Button SaveLogButton {
			get { return withEventsField_SaveLogButton; }
			set {
				if (withEventsField_SaveLogButton != null) {
					withEventsField_SaveLogButton.Click -= SaveLogButton_Click;
				}
				withEventsField_SaveLogButton = value;
				if (withEventsField_SaveLogButton != null) {
					withEventsField_SaveLogButton.Click += SaveLogButton_Click;
				}
			}
