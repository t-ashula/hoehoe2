// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpenTweenConvertor.cs">
...
{
    public class OpenTweenConvertor : IConvertor
    {
        public ISettings ToHoehoeFormat()
        {
            throw new NotImplementedException();
        }

        public bool FromHoehoeFormat(ISettings settings)
        {
            throw new NotImplementedException();
        }
    }
