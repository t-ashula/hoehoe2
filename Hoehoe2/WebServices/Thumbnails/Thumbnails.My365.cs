...
namespace Hoehoe
{
    public partial class Thumbnail
    {
        ...
        private static bool My365_GetUrl(GetUrlArgs args)
        {
            var mc = Regex.Match(string.IsNullOrEmpty(args.Extended) ? args.Url : args.Extended, @"^https?://my365\.in/.+/p/.+$", RegexOptions.IgnoreCase);
            if (!mc.Success)
            {
                return false;
            }
