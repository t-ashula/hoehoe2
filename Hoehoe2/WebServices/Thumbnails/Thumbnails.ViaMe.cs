...
namespace Hoehoe
{
    ...
    public partial class Thumbnail
    {
        ...
        private static bool ViaMe_GetUrl(GetUrlArgs args)
        {
            var mc = Regex.Match(string.IsNullOrEmpty(args.Extended) ? args.Url : args.Extended, @"^https?://via\.me/-(\w+)$", RegexOptions.IgnoreCase);
            if (!mc.Success)
            {
                return false;
            }
